package com.ibeifeng.sparkproject.mockdData;
...
public class MockData {
    public static   void mock(JavaSparkContext sc,SQLContext  sqlContext){
        ...
        String[]   searchKeywords=new String[]{"火锅","蛋糕","重庆辣子鸡","重庆小面","家谱佳品","新辣道鱼火锅","国贸大夏","太古商场","日本料理","温泉"};
        ...
        for(int i=0;i<100;i++){
             ...
             for(int j=0;j<10;j++){
                 ...
                 for(int k=0;k<random.nextInt(100);k++){
                     ...
                     String actionTime=baseActionTime+":"+StringUtils.fulfuil(String.valueOf(random.nextInt(59)))+":"+StringUtils.
                     ...
                     if("search".equals(action)){
                        ...
                        Row row=RowFactory.create(date,userid,sessionid,pageid,actionTime,searchKeyword,clickCategoryId,
                                clickProductId,orderCategoryIds,orderProductIds,payCategoryIds,payProductIds,Long.valueOf(random.nextInt(10)));
                        rows.add(row);
                 }
             }
        }
       JavaRDD<Row> rowsRDD=sc.parallelize(rows);
       StructType   schema=DataTyps.createStructType(Arrays.asList(
               ...
               DataTypes.createStructField("click_categord_id",DataTypes.LongType,true),
               DataTypes.createStructField("click_product_id",DataTypes.LongType,true),
               DataTypes.createStructField("order_category_ids",DataTypes.StringtType,true),
       ...
       df.registerTemTable("user_visit_action");
       ...
       String[] sexes=new String[]{"male","female"};
        for(int  i=0;i<100;i++){
            ...
            String city="professional"+random.nextInt(100);
